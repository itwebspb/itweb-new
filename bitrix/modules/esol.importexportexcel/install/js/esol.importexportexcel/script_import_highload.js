...
var EProfile = {
	...
	{
		var form = $(link).closest('form');
		var post = form.serialize()+'&TYPE=HL&action=checkconnect';
		$.ajax({
			type: "POST",
	...
	ShowFileAuthForm: function()
	{
		...
		var dialog = new BX.CAdminDialog({
			...
			'content_url':'/bitrix/admin/'+kdaIEModuleFilePrefix+'_source_linkauth.php?lang='+BX.message('LANGUAGE_ID')+'&PROFILE_ID='+pid+'&TYPE=HL',
			'content_post': post,
			'width':'900',
			'height':'450',
			'resizable':true});
