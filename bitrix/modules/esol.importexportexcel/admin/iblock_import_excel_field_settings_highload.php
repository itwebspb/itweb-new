...
if($_POST['action']=='save' && is_array($_POST['EXTRASETTINGS']) && check_bitrix_sessid())
{
			...
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					...
					<select name="<?echo $fName;?>" class="chosen">
						...
						{
							echo '<option value="'.htmlspecialcharsbx($k).'"'.(($val==$k || (!$val && $k=='ID')) ? ' selected' : '').'>'.htmlspecialcharsbx($name).'</option>';
						}
						?>
					</select>
				</td>
