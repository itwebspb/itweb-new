...
<div class="kda-ee-tabs" id="kda-ee-help-tabs">
	<div class="kda-ee-tabs-heads">
		<a href="javascript:void(0)" onclick="EHelper.SetTab(this);" class="active" title="<?echo htmlspecialcharsbx(GetMessage("KDA_EE_HELP_TAB1_ALT"));?>"><?echo GetMessage("KDA_EE_HELP_TAB1");?></a>
		<a href="javascript:void(0)" onclick="EHelper.SetTab(this);" title="<?echo htmlspecialcharsbx(GetMessage("KDA_EE_HELP_TAB2_ALT"));?>"><?echo GetMessage("KDA_EE_HELP_TAB2");?></a>
	</div>
