...
<div class="kda-ie-tabs" id="kda-ie-help-tabs">
	<div class="kda-ie-tabs-heads">
		<a href="javascript:void(0)" onclick="EHelper.SetTab(this);" class="active" title="<?echo htmlspecialcharsbx(GetMessage("KDA_IE_HELP_TAB1_ALT"));?>"><?echo GetMessage("KDA_IE_HELP_TAB1");?></a>
		<a href="javascript:void(0)" onclick="EHelper.SetTab(this);" title="<?echo htmlspecialcharsbx(GetMessage("KDA_IE_HELP_TAB2_ALT"));?>"><?echo GetMessage("KDA_IE_HELP_TAB2");?></a>
	</div>
