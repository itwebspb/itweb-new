...
if($_POST['action']=='save' && $_POST['FIELD'])
{
	...
	if(strlen($error)==0)
	{
		...
		if($PropID)
		{
			...
			echo '<script>EList.OnAfterAddNewProperty("'.htmlspecialcharsbx($_REQUEST['FIELD_NAME']).'", "'.$sFieldPrefix.$PropID.'", "'.htmlspecialcharsbx($arFields['NAME']).'", "'.$IBLOCK_ID.'");</script>';
			die();
		}
		else
		{
...
<form action="" method="post" enctype="multipart/form-data" name="new_property" id="newPropertyForm">
	...
	<table width="100%">
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<input type="text" name="FIELD[SORT]" value="<?echo ($_POST['FIELD']['SORT'] ? htmlspecialcharsbx($_POST['FIELD']['SORT']) : '500')?>">
			</td>
		</tr>
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<input type="text" name="FIELD[NAME]" value="<?echo ($_POST['FIELD']['NAME'] ? htmlspecialcharsbx($_POST['FIELD']['NAME']) : '')?>">
			</td>
		</tr>
		...
		<tr>
			...
			<td class="adm-detail-content-cell-r">
				<input type="text" name="FIELD[CODE]" value="<?echo ($_POST['FIELD']['CODE'] ? htmlspecialcharsbx($_POST['FIELD']['CODE']) : '')?>">
			</td>
		</tr>
