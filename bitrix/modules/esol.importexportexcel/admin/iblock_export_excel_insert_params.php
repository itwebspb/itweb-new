...
if($_POST['action']=='save')
{
	...
	{
		$retParams['val'] = '{RATE_'.htmlspecialcharsbx($_POST['CURRENCY_TYPE']).'.'.htmlspecialcharsbx($_POST['CURRENCY']).'}';
	}
		...
		?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					...
					$res = '<select name="DATE_FORMAT" size="'.htmlspecialcharsbx($prop["SIZE"]).'">';
		...
		?>
			<tr>
				...
				<td class="adm-detail-content-cell-r">
					...
					{
						echo '<option value="'.htmlspecialcharsbx($k).'">'.$v.'</option>';
					}
					?>
					</select>				
				</td>
