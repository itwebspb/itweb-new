...
if($_POST['action']=='save' && array_key_exists('NEW_FIELDS_LIST', $_POST))
{
	...
	ob_end_clean();
	$return = htmlspecialcharsbx($_POST['NEW_FIELDS_LIST']);
			...
			<td colspan="2">
				<table width="100%" class="kda-ee-fl-settings-select">
					...
					<tr>
						...
						<td>
							<input type="hidden" name="OLD_FIELDS_LIST" value="<?echo htmlspecialcharsbx(implode(';', $_POST['fields']));?>">
							<input type="hidden" name="NEW_FIELDS_LIST" value="<?echo htmlspecialcharsbx(implode(';', $_POST['fields']));?>">
