	...
	<table width="100%" class="kda-ie-price-calculating">
		...
		<tr>
			<td colspan="2" class="kda-ie-pricing-rels">
				...
				{
				?>
				  <tr data-index="<?echo htmlspecialcharsbx($index);?>">
					<td>
					  <div class="kda-ie-select-mapping">
						<input type="hidden" name="MAP<?echo $jk;?>[<?echo $iblockId;?>][<?echo htmlspecialcharsbx($index);?>][quantity]" value="<?echo htmlspecialcharsbx($arMap['quantity']);?>">
					...
					<td>
					  <div class="kda-ie-select-mapping">
						<input type="hidden" name="MAP<?echo $jk;?>[<?echo $iblockId;?>][<?echo htmlspecialcharsbx($index);?>][price]" value="<?echo htmlspecialcharsbx($arMap['price']);?>">
					...
					<td>
						<input type="text" size="10" name="MAP<?echo $jk;?>[<?echo $iblockId;?>][<?echo htmlspecialcharsbx($index);?>][extra]" value="<?echo htmlspecialcharsbx($arMap['extra']);?>">
					</td>
					<td>
