...
class CKDAImportProfileFS extends CKDAImportProfileAll {
	...
	public function GetList($arFilter=array(), $groups = false)
	{
		...
		{
			$arProfiles = \KdaIE\Utils::Unserialize(file_get_contents($this->fileProfiles), array());
	...
	public function GetByID($ID)
	{
		...
		{
			$arProfile = \KdaIE\Utils::Unserialize(file_get_contents($fn), array());
	...
	public function Copy($ID)
	{
		...
		$arParams = \KdaIE\Utils::Unserialize(file_get_contents($fn), array());
	...
	public function GetProccessParams($id)
	{
		...
		if(file_exists($tmpfile))
		{
			...
			$arParams = \KdaIE\Utils::Unserialize(file_get_contents($paramFile), array());
			return $arParams;
		}
		return false;
	}
