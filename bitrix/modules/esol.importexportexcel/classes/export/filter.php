...
class CKDAEEFilter {
	...
	public function ShowFilterBlock($fid, $arFilter, $fl)
	{
		...
		?>
		<div class="kda-ee-sheet-cfilter" id="<?echo htmlspecialcharsbx($fid);?>" data-type="<?echo htmlspecialcharsbx($this->type);?>" <?if(!in_array($this->type, array('e', 'hl'))){echo ' style="display: none;"';}?>>
