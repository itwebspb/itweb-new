	...
	public function canRead($pFilename)
	{
		...
		if ($zip->open($pFilename) === true) {
			...
			if ($stat && ($stat['size'] <= 255)) {
		        ...
		        $xml = \Bitrix\EsolRedirector\Utils::GetSimplXmlFromString($zip->getFromName('META-INF/manifest.xml'));
...
//		echo '<h1>Meta Information</h1>';
		$xml = \Bitrix\EsolRedirector\Utils::GetSimplXmlFromString($zip->getFromName("meta.xml"));
...
//		echo '<h1>Workbook Content</h1>';
		$xml = \Bitrix\EsolRedirector\Utils::GetSimplXmlFromString($zip->getFromName("content.xml"));
		$namespacesContent = $xml->getNamespaces(true);
//		echo '<pre>';
