...
$MESS["CP_BCS_HIDE_NOT_AVAILABLE"] = "Не отображать недоступные товары";
$MESS["STORES"] = "Склады";
...
$MESS["HIDE_NOT_AVAILABLE_TIP"] = "Товар считается недоступным, если его количество меньше либо равно нулю, включен количественный учет и запрещена покупка при нулевом количестве";
