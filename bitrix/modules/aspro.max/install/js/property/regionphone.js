if (typeof window.JRegionPhone === "undefined") {
  ...
  window.JRegionPhone.prototype = {
    ...
    bindEvents: function () {
      ...
      if (typeof that.onButtonDeleteClick !== "function" && that.table) {
        ...
        if (typeof Sortable === "function") {
          if (that.tbody) {
            Sortable.create(that.tbody, {
              ...
              onMove: function (evt) {
                return (
                  evt.related.querySelector(".no_drag") === null &&
                  evt.related.querySelector(".aspro_property_regionphone_item") !== null
                );
              },
    ...
    unbindEvents: function () {
      if (typeof this.onButtonDeleteClick === "function" && this.table) {
    ...
    getItemsCount: function () {
      if (this.table) {
        return (
          Array.prototype.slice.call(this.table.querySelectorAll("tr .aspro_property_regionphone_item")).length -
    ...
    updateControls: function () {
      if (this.table) {
        if (this.isHasOneRow()) {
          ...
          BX.removeClass(
            this.table.querySelector(".aspro_property_regionphone_item--hiddendrag"),
            "aspro_property_regionphone_item--hiddendrag"
          );
        }
      }
    },
  ...
  window.JRegionPhone._setHref = function (title, href) {
    if (title && typeof title === "object" && href && typeof href === "object") {
  ...
  window.JRegionPhone._bindTitleChange = function (table) {
    if (table && typeof table === "object") {
      BX.bindDelegate(table, "input", { tag: "input", attribute: { type: "text" } }, function (e) {
        if (!e) {
          e = window.event;
        }
        ...
        if (this.getAttribute("name").indexOf("VALUE") !== -1 && this.getAttribute("name").indexOf("PHONE") !== -1) {
      ...
      if (htmlObject && typeof htmlObject === "object") {
        if (htmlObject["html"] && htmlObject["html"].length) {
          if (htmlObject["html"].indexOf("aspro_property_regionphone_item") !== -1) {
            ...
            htmlObject["html"] = row.innerHTML.replace("aspro_property_regionphone_item--hiddenremove", "");
              ...
              if (bAdminList) {
                ...
                if (valueId === null) {
                  htmlObject["html"] = htmlObject["html"].replace(
                    new RegExp("FIELDS\\[([^\\]]*)\\]\\[(PROPERTY_\\d+)\\]\\[([^\\]]*)\\]", "ig"),
                    "FIELDS[$1][$2][n0]"
                  );
                }
              } else {
      ...
      for (var i in adminRows) {
        ...
        if (adminRow) {
          ...
          var items = Array.prototype.slice.call(
            adminRow.querySelectorAll(".aspro_property_regionphone_item--admlistedit")
          );
          for (var i in items) {
