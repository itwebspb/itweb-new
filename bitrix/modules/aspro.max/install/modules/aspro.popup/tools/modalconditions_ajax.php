...
if($action){
	if($action === 'init' || $action === 'save'){
		...
		$eventManager->RegisterEventHandler('catalog', 'OnCondCatControlBuildList', 'aspro.popup', '\Aspro\Popup\Property\ModalConditions\CondModal', 'GetControlDescr');
		...
		$eventManager->UnRegisterEventHandler('catalog', 'OnCondCatControlBuildList', 'aspro.popup', '\Aspro\Popup\Property\ModalConditions\CondModal', 'GetControlDescr');
