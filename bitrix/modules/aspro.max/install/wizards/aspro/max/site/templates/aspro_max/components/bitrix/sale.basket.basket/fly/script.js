...
function delete_all_items(type, item_section, correctSpeed){
	...
	if(type == "na")
		index = 4;
	$.post( arMaxOptions['SITE_DIR']+'ajax/show_basket_fly.php', 'PARAMS='+encodeURIComponent($("#basket_form").find("input#fly_basket_params").val())+'&TYPE='+index+'&CLEAR_ALL=Y', $.proxy(function( data ) {
		basketFly('open');
