						...
						<div class="bx_filter_parameters">
							...
							foreach($arResult["ITEMS"] as $key => $arItem){
							    if(isset($arItem["ASPRO_FILTER_SORT"]) && $arItem["VALUES"]){
									...
									$isFilter=true;
									?>
									<div class="bx_filter_parameters_box bx_sort_filter <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code="<?=htmlspecialcharsbx(strtolower($arItem['CODE']));?>" data-property_id="<?=intval($arItem['ID']);?>">
														...
														<div class="props_list">
															<?if($arParams["SHOW_HINTS"]){
																...
																<?if( $arItem["FILTER_HINT"] && strpos( $arItem["FILTER_HINT"],'line')===false){?>
																	<div class="hint"><span class="icon"><i>?</i></span><div class="tooltip" style="display: none;"><?=htmlspecialcharsbx($arItem["FILTER_HINT"]);?></div></div>
																<?}?>
															<?}?>
														</div>
													</div>
							...
							foreach($arResult["ITEMS"] as $key=>$arItem)
							{
								...
								if(isset($arItem["PRICE"])):
									...
									<div class="bx_filter_parameters_box active" data-property_name="<?=htmlspecialcharsbx($arItem['NAME']);?>">
										<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
										<div class="bx_filter_parameters_box_title colored_theme_hover_bg-block" >
							...
							foreach($arResult["ITEMS"] as $key=>$arItem)
							{
								...
								$isFilter=true;
								?>
								<div class="bx_filter_parameters_box <?=$class;?>" data-expanded="<?=($arItem["DISPLAY_EXPANDED"] ? $arItem["DISPLAY_EXPANDED"] : "N");?>" data-prop_code=<?=htmlspecialcharsbx(strtolower($arItem['CODE']));?> data-property_id="<?=intval($arItem['ID']);?>" data-property_name="<?=htmlspecialcharsbx($arItem['NAME']);?>">
									<span data-f="<?=Loc::getMessage('CT_BCSF_SET_FILTER')?>" data-fi="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TI')?>" data-fr="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TR')?>" data-frm="<?=Loc::getMessage('CT_BCSF_SET_FILTER_TRM')?>" class="bx_filter_container_modef"></span>
									<?if(!$arItem['IS_PROP_INLINE']){?>
										<div class="bx_filter_parameters_box_title colored_theme_hover_bg-block" >
											<div>
													...
													<?if($ar["VALUE"]){?>
														...
														<div class="pict">
															<input
																...
																id="<?=$ar["CONTROL_ID"]?>"
																value="<?=$ar["HTML_VALUE"]?>"
																data-title="<?=htmlspecialcharsbx($ar['VALUE']);?>"
															...
															<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label nab dib<?=$class?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'active');">
																<?/*<span class="bx_filter_param_btn bx_color_sl" title="<?=htmlspecialcharsbx($ar['VALUE']);?>">*/?>
																	<?if (isset($ar["FILE"]) && !empty($ar["FILE"]["SRC"])):?>
																	<span class="bx_filter_btn_color_icon" title="<?=htmlspecialcharsbx($ar['VALUE']);?>" style="background-image:url('<?=$ar["FILE"]["SRC"]?>');"></span>
																	<?endif?>
																<?/*</span>*/?>
															</label>
														</div>
													...
													<?if($ar["VALUE"]){?>
														...
														<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label<?=$class?> pal nab" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'active');">
															<?/*<span class="bx_filter_param_btn bx_color_sl" title="<?=htmlspecialcharsbx($ar['VALUE']);?>">*/?>
																...
																<?endif?>
															<?/*</span>*/?>
															<span class="bx_filter_param_text" title="<?=htmlspecialcharsbx($ar['VALUE']);?>"><?=htmlspecialcharsbx($ar['VALUE']);?><?
													...
													<div class="bx_filter_select_block" onclick="smartFilter.showDropDownPopup(this, '<?=CUtil::JSEscape($key)?>')">
														...
														<div class="bx_filter_select_popup" data-role="dropdownContent" style="display: none;">
															...
															?>
																<?$ar["CONTROL_ID"] .= $arParams['AJAX_FILTER_FLAG'];?>
																<li>
																	<label for="<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label<?=$class?>" data-role="label_<?=$ar["CONTROL_ID"]?>" onclick="smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')"><?=htmlspecialcharsbx($ar['VALUE']);?></label>
																</li>
															<?endforeach?>
															</ul>
														</div>
													...
													<div class="filter label_block radio">
														...
														<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx_filter_param_label <?=$class;?>" for="<? echo $ar["CONTROL_ID"] ?>">
															<span class="bx_filter_input_checkbox">
																...
																<span class="bx_filter_param_text1" title="<?=htmlspecialcharsbx($ar['VALUE']);?>"><?=htmlspecialcharsbx($ar['VALUE']);?><?
																if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
																	?> (<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
																endif;?></span>
															</span>
