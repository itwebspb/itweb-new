			...
			<?if($arAllSections):?>
				...
				<div class="categories_block menu_top_block">
					<ul class="categories left_menu dropdown">
                        <li><a href="<?=$arParams['SEF_FOLDER'];?>" class="categories_link bordered rounded2"><span class="categories_name darken"><?=GetMessage("ALL_SECTION")?></span></a></li>
...
<?endif;?>
<?(new \Aspro\Max\Scheme\Detail\News($arParams, $arElement))->show();?>
