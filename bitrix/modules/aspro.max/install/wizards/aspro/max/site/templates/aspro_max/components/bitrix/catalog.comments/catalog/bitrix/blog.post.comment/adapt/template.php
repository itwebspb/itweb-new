            ...
            if ($comment['SHOW_AS_HIDDEN'] == 'Y' || $comment['PUBLISH_STATUS'] == BLOG_PUBLISH_STATUS_PUBLISH || $comment['SHOW_SCREENNED'] == 'Y' || $comment['ID'] == 'preview') {
                ...
                <?if (
                    ...
                    <div class="alert alert-danger">
                        <?php
                        $errorMessages = [];
                        foreach ($_SESSION['NOT_ADDED_FILES']['FILES'] as $error) {
                            $errorMessages[] = $error['FILE_NAME'].' - '.$error['MESSAGE'];
                        }
                        unset($_SESSION['NOT_ADDED_FILES']);
                        ?>
                        <?=GetMessage('NOT_ADDED_FILES');?>
                        <br />
                        <?=TSolution\Utils::sanitizeHtml(implode('<br>', $errorMessages));?>
                    </div>
                <?endif;?>
