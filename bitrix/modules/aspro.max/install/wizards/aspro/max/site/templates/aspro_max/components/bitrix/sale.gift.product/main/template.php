...
if (!empty($arResult['ITEMS'])){
	...
	<div class="ordered-block gifts">
		<div class="bx_item_list_you_looked_horizontal detail <? echo $templateData['TEMPLATE_CLASS']; ?>">
            ...
            ?>
				<div class="all_wrapp relative swiper-nav-offset">
					<div class="content_inner items tab short-nav hidden-dots catalog_block ajax_load swiper slider-solution swipeignore slides mobile-offset" data-plugin-options='<?=Bitrix\Main\Web\Json::encode($arOptions);?>'>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
								<div class="catalog_item item item_block itemvisible main_item_wrapper" id="<?=$arItem["strMainID"];?>">
