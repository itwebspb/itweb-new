...
<?if(!$arResult['POPUP']):?>
	<?if(
		...
		<div class="region_wrapper visible-by-block-presence__condition">
	...
	<?endif;?>
<?else:?>
	<div class="popup_regions visible-by-block-presence__condition <?=($arResult['ONLY_SEARCH_ROW'] ? 'only_search' : '')?>">
