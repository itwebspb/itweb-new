...
use Aspro\Max\Validation as SolutionValidation;
...
var arAsproOptions = window[solutionName] = ({
    SOLUTION_ID: '<?=$moduleClass::moduleID;?>',
    "SITE_DIR" : "<?=$SITE_DIR;?>",
    "SITE_ID" : "<?=$SITE_ID;?>",
    ...
    "THEME" : ({
        'CAPTCHA_ON_SUBSCRIBE' : '<?=$arFrontParametrs['CAPTCHA_ON_SUBSCRIBE'];?>',
    ...
    VALIDATION: {
        FORM_INPUT_NAME: '<?=SolutionValidation::getFormFieldName();?>'
    },
    "JS_ITEM_CLICK":({
        "precision" : 6,
