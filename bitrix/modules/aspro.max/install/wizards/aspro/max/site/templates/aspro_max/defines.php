...
$bShowServices = ($bActiveTheme || ($arTheme['INDEX_TYPE']['SUB_PARAMS'][$indexType]['SERVICES']['VALUE'] != 'N'));
$bServicesIndexClass = ($arTheme['INDEX_TYPE']['SUB_PARAMS'][$indexType]['SERVICES']['VALUE'] == 'Y' ? '' : 'hidden');
$bServicesIndexClass .= ($arTheme['FON_PARAMS']['fon'.$indexType.'SERVICES'] == 'Y' ? ' grey_block' : '');
