...
Option::set('aspro.max', "SOCIAL_MAX", $wizard->GetVar("shopMAX"), WIZARD_SITE_ID);
...
// add .htaccess to crm logs folder
$logHtaccessFilePathFrom = str_replace('//', '/', WIZARD_ABSOLUTE_PATH.'/site/services/iblock/files/logs/.htaccess');
if (file_exists($logHtaccessFilePathFrom)) {
    $logHtaccessFilePathTo = str_replace('//', '/', $_SERVER['DOCUMENT_ROOT'].'/upload/logs/aspro.max/crm/.htaccess');

    CopyDirFiles($logHtaccessFilePathFrom, $logHtaccessFilePathTo, true);
}
