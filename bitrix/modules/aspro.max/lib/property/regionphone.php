...
class RegionPhone{
                    ...
                    <div class="inner checkbox">
						<div class="inner_wrapper">
							<div class="title_wrapper">
								<div class="subtitle"><label for="<?=$telegramName?>"><?=Loc::getMessage('MAX_REGION_PHONE_TELEGRAM_TITLE')?></label></div>
							</div>
							<div class="value_wrapper">
								<input type="checkbox" readonly disabled id="<?=$telegramName?>" name="<?=$telegramName?>" value="Y" <?=($telegram === 'Y' ? 'checked' : '')?> title="<?=htmlspecialcharsbx(Loc::getMessage('MAX_REGION_PHONE_TELEGRAM_TITLE'))?>"/>
							</div>
						</div>
                    </div>
                    <div class="inner checkbox">
					    <div class="inner_wrapper">
							<div class="title_wrapper">
								<div class="subtitle"><label for="<?=$whatsappName?>"><?=Loc::getMessage('MAX_REGION_PHONE_WHATSAPP_TITLE')?></label></div>
							</div>
							<div class="value_wrapper">
								<input type="checkbox" readonly disabled id="<?=$whatsappName?>" name="<?=$whatsappName?>" value="Y" <?=($whatsapp === 'Y' ? 'checked' : '')?> title="<?=htmlspecialcharsbx(Loc::getMessage('MAX_REGION_PHONE_WHATSAPP_TITLE'))?>"/>
							</div>
						</div>
                    </div>
                </div>
	...
	public static function GetPropertyFieldHtml($arProperty, $value, $strHTMLControlName){
		...
		if($value){
			...
			$descriptionName = str_replace('VALUE', 'DESCRIPTION', $strHTMLControlName['VALUE']);
			$telegram = $value['VALUE']['TELEGRAM'];
			$telegramName = $strHTMLControlName['VALUE'].'[TELEGRAM]';
			$whatsapp = $value['VALUE']['WHATSAPP'];
			$whatsappName = $strHTMLControlName['VALUE'].'[WHATSAPP]';
		}
				...
				<div class="inner_wrapper">
                    ...
                    <div class="inner checkbox">
						<div class="inner_wrapper">
							...
							<div class="value_wrapper">
								<input type="checkbox" id="<?=$telegramName?>" name="<?=$telegramName?>" value="Y" <?=($telegram === 'Y' ? 'checked' : '')?> title="<?=htmlspecialcharsbx(Loc::getMessage('MAX_REGION_PHONE_TELEGRAM_TITLE'))?>"/>
							</div>
						</div>
                    </div>
                    <div class="inner checkbox">
					    <div class="inner_wrapper">
							...
							<div class="value_wrapper">
								<input type="checkbox" id="<?=$whatsappName?>" name="<?=$whatsappName?>" value="Y" <?=($whatsapp === 'Y' ? 'checked' : '')?> title="<?=htmlspecialcharsbx(Loc::getMessage('MAX_REGION_PHONE_WHATSAPP_TITLE'))?>"/>
							</div>
						</div>
                    </div>
					<?if(!$bEditProperty):?>
	...
	public static function ConvertToDB($arProperty, $value){
		...
		$value['VALUE'] = array(
			...
			'TELEGRAM' => ($value['VALUE']['TELEGRAM'] === 'Y' ? 'Y' : 'N'),
			'WHATSAPP' => ($value['VALUE']['WHATSAPP'] === 'Y' ? 'Y' : 'N'),
		);
