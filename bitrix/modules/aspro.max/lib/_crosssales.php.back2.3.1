											...
											if(isset($arRule['PROPERTY_EXT_PRODUCTS_FILTER_VALUE']) && is_string($arRule['PROPERTY_EXT_PRODUCTS_FILTER_VALUE'])){
												...
												if($arTmpExtProductsFilter && $arTmpExtProductsFilter['CHILDREN']){
													...
													if($arRule['PROPERTY_EXT_PRODUCTS_FILTER_VALUE']){
														...
														$arRule['PROPERTY_SHOW_PLACE_ENUM_ID'] = (
															!empty($arRule['PROPERTY_SHOW_PLACE_ENUM_ID']) ? (array)$arRule['PROPERTY_SHOW_PLACE_ENUM_ID'] : 
																($arRule['PROPERTY_SHOW_PLACE_VALUE'] ? array_keys($arRule['PROPERTY_SHOW_PLACE_VALUE']) : array_values($arShowPlaces))
														);
