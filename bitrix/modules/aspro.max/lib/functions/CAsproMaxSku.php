				...
				<div class="price_matrix_wrapper">
					<div class="prices-wrapper">
                        ...
                        <?if ($arParams['USE_SCHEMA']):?>
                            <meta itemprop="priceCurrency" content="<?=htmlspecialchars($minPrice["CURRENCY"])?>">
                            <meta itemprop="price" content="<?=htmlspecialchars($minPrice["DISCOUNT_VALUE"] ?: $minPrice["VALUE"])?>">
                        <?endif;?>
					</div>
