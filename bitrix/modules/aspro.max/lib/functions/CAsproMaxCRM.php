...
if (!class_exists('CAsproMaxCRM')) {
    class CAsproMaxCRM
    {
        public const MODULE_ID = \CMax::moduleID;
        public const ACLOUD_PATH = 'https://#DOMAIN#';
        public const ACLOUD_SHORT_PATH = 'https://#DOMAIN#.acloud.ru';
        public const AMO_CRM_PATH = 'https://#DOMAIN#.amocrm.ru';

        public static $arCrmFileds = [
            'MAIN' => [
                'FORM_NAME' => '',
                'FORM_SID' => '',
                'SITE_ID' => '',
        ...
        public static function addFileds($arFields = [])
        {
            self::$arCrmFileds = array_merge(self::$arCrmFileds, (array) $arFields);
        }

        public static function updateToken(&$arOAuth, $arConfig = [], $tokenType = 'accessToken')
        {
            $arResponse = [];

            $arOAuth = is_array($arOAuth) ? $arOAuth : [];
            foreach (
                [
                    'accessToken',
                    'accessTokenExpires',
            ...
            $arConfig = is_array($arConfig) ? $arConfig : [];
        ...
        public static function updateOAuth(&$arOAuth, $arConfig = [])
        {
            $arResponse = [];
        ...
        public static function checkOAuth(&$arOAuth, $arConfig = [])
        {
            $arResponse = [];
        ...
        public static function save($arOAuth, $arConfig)
        {
            ...
            if ($type === 'AMO_CRM') {
                ...
                Option::set(self::MODULE_ID, 'HASH_'.$type, $hash = md5(serialize([$domain, $clientSecret, $clientId, $authCode])), $siteId);
            }
        }
        ...
        public static function query(
            ...
            if ($decode) {
                $result_text = $GLOBALS['APPLICATION']->ConvertCharset($result_text, 'UTF-8', LANG_CHARSET);
            }
