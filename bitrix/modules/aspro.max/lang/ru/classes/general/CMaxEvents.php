...
$MESS['CRM_SEND'] = 'Сделка CRM';
$MESS['CRM_OPEN_LEAD'] = 'Открыть в #CRM_DOMAIN#';
$MESS['CRM_SEND_ORDER'] = 'Отправить в #CRM_DOMAIN#';
...
$MESS["EMAILS_DUBLICATE_WHEN_AUTH"] = "Обнаружено более <b>#DUBLICATES#</b> пользователей c одинаковыми email адресами (<b>#EMAIL#</b>) на сайте, авторизуйтесь по уникальному <b>логину</b>. Если вы забыли свой логин, то можете воспользоваться формой <a href='/auth/forgot-password/' class='alert-link'>забыли пароль</a>, при отправке которой будет получено письмо с регистрационными данными.";
