...
$MESS["ASPRO_MAX_NO_SITE_INSTALLED"] = 'No sites found with "Аспро: Max - Online Store" solution installed<br />
...
$MESS["MAX_MODULE_EDIT_ROBOTS"] = "Edit robots.txt";
$MESS["MAX_MODULE_FILES"] = "Files";
$MESS["MAX_MODULE_GENERATE_ROBOTS"] = "Regenerate robots.txt";
$MESS["MAX_MODULE_GENERATE_ROBOTS_SHORT"] = "Regenerate";
$MESS["MAX_MODULE_NOT_INCLUDED"] = 'Failed to connect module Аспро: Max';
$MESS["MAX_MODULE_NOT_INSTALLED"] = 'Module "Аспро: Max - online store" not installed. Please <a href="/bitrix/admin/partner_modules.php">install the module</a> and try again.';
$MESS["MAX_MODULE_ROBOTS_ERROR"] = "Turn on regionality and select the type \"on subdomains\" to allow robots.txt to be regenerated";
$MESS["MAX_MODULE_ROBOTS_INFO"] = "<p>Clicking the <b>\"Regenerate robots.txt\"</b> button will copy the main <b>/robots.txt</b> file to the <b> directory /aspro_regions/robots/</b> for each domain of the form <b>robots_DOMAIN.txt</b> in which the site address for each domain in the <b>Host</b></p><p> directive will be replaced it is possible to recreate <b>robots.txt</b> only for a specific domain using the button <b>\"Recreate\"</b></p>";
$MESS["MAX_MODULE_ROBOTS_MAIN"] = "Main robots.txt";
$MESS["MAX_NO_RIGHTS_FOR_VIEWING"] = 'Access Denied';
$MESS["MAX_PAGE_TITLE"] = 'Generating robots.txt';
