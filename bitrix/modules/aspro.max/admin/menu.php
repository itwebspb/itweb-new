            ...
            $arMenu = [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'icon' => 'imi imi_campaign_master',
                    ],
                ],
            ];

            if (!CModule::IncludeModule('aspro.sku')) {
                $arMenu['items'][] = [
                    'text' => Loc::getMessage('ASPRO_MAX_SKU__DOWNLOAD_TEXT'),
                    'title' => Loc::getMessage('ASPRO_MAX_SKU__DOWNLOAD_TITLE'),
                    'sort' => 1000,
                    'url' => '/bitrix/admin/'.$moduleID.'_module_sku.php?lang='.urlencode(LANGUAGE_ID),
                    'icon' => 'imi imi_main_sku',
                ];
            }
