																											...
																											<?if($leadFieldsMap):?>
																												<optgroup label="<?=Loc::getMessage('FORM_FIELD_CRM_FIELDS_LEAD')?>">
																													<?foreach($leadFieldsMap as $key2 => $text):?>
																														<option <?=($key2 == $crm_FORM_field_id ? 'selected' : '')?> value="<?=htmlspecialcharsbx($key2)?>"><?=htmlspecialcharsbx($text)?></option>
																													<?endforeach;?>
																												</optgroup>
																											<?endif;?>
																											...
																											<?if($formsFieldsMap):?>
																												<optgroup label="<?=Loc::getMessage('FORM_FIELD_CRM_FIELDS_FORM_FIELDS_TITLE')?>">
																													<?foreach($formsFieldsMap as $key2 => $text):?>
																														<option <?=($key2 == $form_field_id ? 'selected' : '')?> value="<?=htmlspecialcharsbx($key2)?>"><?=htmlspecialcharsbx($text)?></option>
																													<?endforeach;?>
																												</optgroup>
																											<?endif;?>
																						...
																						<td class="adm-detail-content-cell-l" style="width:50%;">
																							<select name="CRM_FORM_FIELD_<?=$optionsSiteID?>[<?=$formId?>][]" class="field_crm" style="width:300px;">
																								...
																								<?if($leadFieldsMap):?>
																									<optgroup label="<?=Loc::getMessage('FORM_FIELD_CRM_FIELDS_LEAD')?>">
																										<?foreach($leadFieldsMap as $key2 => $text):?>
																											<option value="<?=htmlspecialcharsbx($key2)?>"><?=htmlspecialcharsbx($text)?></option>
																										<?endforeach;?>
																									</optgroup>
																								<?endif;?>
																								<?if($leadCustomFieldsMap):?>
																			...
																			<?elseif(
																				...
																				while ($arFormResult = $rsData->fetch()) {
																					...
																					if ($bSended) {
																						...
																						$url = $url ? '<a href="'.htmlspecialcharsbx($domain.$url).'" target="_blank">'.htmlspecialcharsbx($leadId).'</a>' : htmlspecialcharsbx($leadId);
												...
												<?if($arOption['VALUES']):?>
													<tr>
														<td colspan="2">
															...
															$orderTabControl = new CAdminViewTabControl('orderTabControl'.$optionsSiteID, $aOrdersTabs);
																									...
																									<td class="adm-detail-content-cell-l" style="width:50%;">
																										<select name="CRM_ORDER_FIELD_<?=$optionsSiteID?>[<?=$personTypeId?>][]" class="field_crm" style="width:300px;">
																											...
																											<?if($leadFieldsMap):?>
																												<optgroup label="<?=Loc::getMessage('FORM_FIELD_CRM_FIELDS_LEAD')?>">
																													<?foreach($leadFieldsMap as $key2 => $text):?>
																														<option <?=($key2 == $crm_ORDER_field_id ? 'selected' : '')?> value="<?=htmlspecialcharsbx($key2)?>"><?=htmlspecialcharsbx($text)?></option>
																													<?endforeach;?>
																												</optgroup>
																											<?endif;?>
																											<?if($leadCustomFieldsMap):?>
																											...
																											<?if($ordersFieldsMap):?>
																												<optgroup label="<?=Loc::getMessage('FORM_FIELD_CRM_FIELDS_ORDER_FIELDS_TITLE')?>">
																													<?foreach($ordersFieldsMap as $key2 => $text):?>
																														<option <?=($key2 == $order_field_id ? 'selected' : '')?> value="<?=htmlspecialcharsbx($key2)?>"><?=htmlspecialcharsbx($text)?></option>
																													<?endforeach;?>
																												</optgroup>
																											<?endif;?>
																		...
																		<td colspan="2">
																			...
																			<?elseif(
																				...
																				while ($arOrder = $rsData->fetch()) {
																					...
																					if ($bSended) {
																						$url = Lead::getUrl($leadId);
																						$url = $url ? '<a href="'.htmlspecialcharsbx($domain.$url).'" target="_blank">'.$leadId.'</a>' : $leadId;
																						$row->AddField('LEAD', $url);
																					} else {
