...
$downloadModuleId = 'aspro.sku';
$bModuleInstalled = Loader::includeModule($downloadModuleId);
$downloadModuleClass = str_replace('.', '_', $downloadModuleId);
$downloadTemplateId = 'sku';
$moduleName = Loc::getMessage('ASPRO_MODULE_SKU_NAME');

$linkToModule = '/bitrix/admin/aspro/sku/settings.php?lang='.urlencode(LANGUAGE_ID);
