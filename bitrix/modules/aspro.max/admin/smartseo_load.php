		...
		<form method="post" class="smartseo-download-form" enctype="multipart/form-data" action="<?=$APPLICATION->GetCurPage()?>?lang=<?=LANGUAGE_ID?>">
			...
			<?foreach($arTabs as $key => $arTab){
				...
				<div class="module-info-wrapper-outer">
                    ...
                    <div class="module-main-title"><?=Loc::getMessage('ASPRO_SMARTSEO_MAIN_TITLE'); ?></div>

					<div class="module-additional-info">
						<?=Loc::getMessage('ASPRO_SMARTSEO_ADDITIONAL_DESC'); ?>
					</div>

					<div class="module-additional-info">
						<div class="module-additional-info__title"><?=Loc::getMessage('ASPRO_SMARTSEO_ADVANTAGES'); ?></div>
						<ul class="module-additional-info__list">
					...
					<div class="module-additional-info">
						<div class="module-additional-info__title"><?=Loc::getMessage('ASPRO_SMARTSEO_WHO_USEFUL'); ?></div>
						<ul class="module-additional-info__list">
					...
					<div class="module-additional-info">
						<div class="module-additional-info__title"><?=Loc::getMessage('ASPRO_SMARTSEO_MAIN_BLOCKS'); ?></div>
						<ul class="module-additional-info__list">
