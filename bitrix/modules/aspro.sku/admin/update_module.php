...
// title
$APPLICATION->SetTitle(Loc::getMessage('ASPRO_UPDATE_SKU__PAGE_TITLE'));

// css & js
$APPLICATION->SetAdditionalCss('/bitrix/css/'.$moduleAssetsPath.'/update_module.css');
...
if ($bShowNotify) {
    CAdminNotify::Add(
        [
            'MESSAGE' => Loc::getMessage('ASPRO_UPDATE_SKU__UPDATE_OBF_FILES_ERROR'),
            'TAG' => 'aspro_sku',
            'MODULE_ID' => $moduleID,
        ]
    );
                    ...
                    <div class="aspro-update__wrap" style="max-width:540px;">
                        <div class="aspro-update__info">
                            ...
                            <div class="aspro-update__description" style="display: none;">
                                <input type="button" class="aspro-update__description-button adm-btn" name="description-smartsearch" value="<?=Loc::getMessage('ASPRO_UPDATE__BUTTON_DESCRIPTION');?>" title="<?=Loc::getMessage('ASPRO_UPDATE__BUTTON_DESCRIPTION');?>">
                            </div>
                        </div>
                        ...
                        <div class="aspro-update__download-wrap" style="display: none;">
                            ...
                            <br>
                            <input type="button" class="aspro-update__download submit-btn adm-btn-save" name="download-smartsearch" value="<?=Loc::getMessage('ASPRO_UPDATE__BUTTON_DOWNLOAD');?>" title="<?=Loc::getMessage('ASPRO_UPDATE__BUTTON_DOWNLOAD');?>">
                        </div>
                ...
                $(document).ready(function() {
                    function sendAction(action, step) {
                        if (
                            ...
                            const $form = $('.aspro-update__download-form');
                            if ($form.length) {
                                const data = {
                    ...
                    $(document).on('click', '.aspro-update__description-button', function() {
                        if (typeof window.updatePopup === 'undefined') {
                            ...
                            if (popupInner) {
                                popupInner.classList.add('smartsearch-scrollblock');
                            }
