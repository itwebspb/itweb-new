        ...
        'GROUPS' => [
            'TYPE' => [
                'ITEMS' => [
                    ...
                    [
                        "TYPE" => "DROPDOWN",
                        "ID" => "base_action_select_".$gridSitemap['GRID_ID'],
                        "NAME" => "action_button_".$gridSitemap['GRID_ID'],
                        "ITEMS" => [
                            [
                            ...
                            [
                                "NAME" => Loc::getMessage('SMARTSEO_GRID_SITEMAP_PANEL_ACTION_ACTIVATE'),
                                "VALUE" => "activate",
                                "ONCHANGE" => [
                                    ...
                                    [
                                        ...
                                        "DATA" => [$gridSnippet->getApplyButton([
                                            "ONCHANGE" => [[
                                                    ...
                                                    "DATA" => [
                                                        [
                                                            'JS' => 'contextMenuGridSitemap.actionActivateSelected()'
                                                        ]
                                                    ]
                                                ]]
                                            ]
                            ...
                            [
                                "NAME" => Loc::getMessage('SMARTSEO_GRID_SITEMAP_PANEL_ACTION_DEACTIVATE'),
                                "VALUE" => "deactivate",
                                "ONCHANGE" => [
                                    ["ACTION" => "RESET_CONTROLS"],
                                    [
                                        ...
                                        "DATA" => [$gridSnippet->getApplyButton([
                                            "ONCHANGE" => [[
                                                    ...
                                                    "DATA" => [
                                                        [
                                                            'JS' => 'contextMenuGridSitemap.actionDeactivateSelected()'
                                                        ]
                                                    ]
                                                ]]
                                            ]
