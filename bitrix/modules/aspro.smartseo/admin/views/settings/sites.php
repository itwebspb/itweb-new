              ...
              <div class="aspro-smartseo__form-detail__body">
                <div class="adm-detail-content-item-block">
                  <table class="adm-detail-content-table edit-table">
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="adm-info-message-wrap aspro-smartseo__adm-info-message">
                                <div class="adm-info-message"><?= Loc::getMessage('SMARTSEO__REPLACE_NOTICE') ?></div>
                            </div>
                        </td>
                    </tr>

                    <tr>
                        <td width="40%" class="adm-detail-content-cell-l"><?= Loc::getMessage('SMARTSEO__FORM_ENTITY__NEW_URL_REPLACE_SPECIAL_CHAR_STRING') ?>: </td>
                        <td width="60%" class="adm-detail-content-cell-r">
                        <div class="aspro-smartseo__form-control">
                            <input class="aspro-smartseo__form-control__input" type="checkbox" name="<?= $alias ?>[NEW_URL_REPLACE_SPECIAL_CHAR_STRING]" <?= $data[$site['LID']]['NEW_URL_REPLACE_SPECIAL_CHAR_STRING'] === 'Y' ? 'checked' : '' ?> value="Y">
                        </div>
                        </td>
                    </tr>

                    <tr class="heading">
                      <td colspan="2"><?= Loc::getMessage('SMARTSEO__FORM_GROUP__CURRENCY') ?></td>
                    </tr>

                    <tr>
                        <td width="40%" class="adm-detail-content-cell-l"><?= Loc::getMessage('SMARTSEO__FORM_ENTITY__CONVERT_CURRENCY') ?>: </td>
                        <td width="60%" class="adm-detail-content-cell-r">
                        <div class="aspro-smartseo__form-control">
                            <input class="aspro-smartseo__form-control__input" type="checkbox" name="<?= $alias ?>[CONVERT_CURRENCY]" <?= $data[$site['LID']]['CONVERT_CURRENCY'] !== 'N' ? 'checked' : '' ?> value="Y">
                        </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                      <td width="40%"
                          class="adm-detail-content-cell-l"><?= Loc::getMessage('SMARTSEO__FORM_ENTITY__CURRENCY_ID') ?>:
                      </td>
                      <td width="60%" class="adm-detail-content-cell-r">
                        <div class="aspro-smartseo__form-control">
                          <select name="<?= $alias ?>[CURRENCY_ID]"
                                  class="aspro-smartseo__form-control__select">
                              <? $currentValue = $data[$site['LID']]['CURRENCY_ID'] ?: $data['default']['CURRENCY_ID'] ?>
                              <? foreach ($listCurrenciesOptions as $code => $value) : ?>
                                <option value="<?= $code ?>" <?= $code == $currentValue ? 'selected' : '' ?>><?= $value ?></option>
                              <? endforeach; ?>
                          </select>
                        </div>
                    ...
                    <tr>
                        <td colspan="2">
                            <div class="adm-info-message-wrap aspro-smartseo__adm-info-message">
                                <div class="adm-info-message"><?= Loc::getMessage('SMARTSEO__CURRENCY_NOTICE') ?></div>
                            </div>
                        </td>
                    </tr>
