        ...
        'GROUPS' => [
            'TYPE' => [
                'ITEMS' => [
                    [
                        ...
                        'ONCHANGE' => [
                            [
                                ...
                                'DATA' => [
                                    [
                                        'JS' => 'contextMenuGridCondition.actionDeleteSelected()'
                                    ],
                                ],
                            ],
                        ],
                    ...
                    [
                        "TYPE" => "DROPDOWN",
                        "ID" => "base_action_select_".$gridTags['GRID_ID'],
                        "NAME" => "action_button_".$gridTags['GRID_ID'],
                        "ITEMS" => [
                            [
                            ...
                            [
                                "NAME" => Loc::getMessage('SMARTSEO_GRID_CONDITION_PANEL_ACTION_ACTIVATE'),
                                "VALUE" => "activate",
                                "ONCHANGE" => [
                                    ...
                                    [
                                        ...
                                        "DATA" => [$gridSnippet->getApplyButton([
                                            "ONCHANGE" => [[
                                                    ...
                                                    "DATA" => [
                                                        [
                                                            'JS' => 'contextMenuGridCondition.actionActivateSelected()'
                                                        ]
                                                    ]
                                                ]]
                                            ]
                            ...
                            [
                                "NAME" => Loc::getMessage('SMARTSEO_GRID_CONDITION_PANEL_ACTION_DEACTIVATE'),
                                "VALUE" => "deactivate",
                                "ONCHANGE" => [
                                    ["ACTION" => "RESET_CONTROLS"],
                                    [
                                        ...
                                        "DATA" => [$gridSnippet->getApplyButton([
                                            "ONCHANGE" => [[
                                                    ...
                                                    "DATA" => [
                                                        [
                                                            'JS' => 'contextMenuGridCondition.actionDeactivateSelected()'
                                                        ]
                                                    ]
                                                ]]
                                            ]
