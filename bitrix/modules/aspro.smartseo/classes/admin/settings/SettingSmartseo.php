...
class SettingSmartseo
{
    ...
    public function getParametersGeneratingUrl()
    {
        ...
        return [
            ...
            'REPLACE_SPECIAL_CHAR_STRING' => $this->currentSite['NEW_URL_REPLACE_SPECIAL_CHAR_STRING'] === "Y",
    ...
    public function getParametersCurrency(){
        return [
            'CONVERT_CURRENCY' =>  $this->currentSite['CONVERT_CURRENCY'],
            'CURRENCY_ID' =>  $this->currentSite['CURRENCY_ID'],
        ];
    }
