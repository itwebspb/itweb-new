...
if($USER && !$USER->IsAuthorized() && PHP_SAPI=='cli')
{
...
foreach($arProfiles as $PROFILE_ID)
{
	...
	{
		if(\KdaIE\Utils::IsUtfMode()) $DATA_FILE_NAME = $APPLICATION->ConvertCharsetArray($DATA_FILE_NAME, LANG_CHARSET, 'CP1251');
	...
	if(isset($arResult['action']) && $arResult['action']=='finish_error')
	{
		echo date('Y-m-d H:i:s').": import error\r\n"."Profile id = ".$PROFILE_ID."\r\n".implode("\r\n", $arResult['errors'])."\r\n\r\n";
	}
	else
	{
