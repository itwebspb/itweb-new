...
$email = htmlspecialcharsbx((string)($arResult['REQUEST']['EMAIL'] ?? ''));
$emailTitle = htmlspecialcharsbx(GetMessage('subscr_auth_email'));
?>
...
<tr valign="top">
	<td width="40%">
		<p>e-mail<br /><input type="text" name="sf_EMAIL" size="20" value="<?=$email;?>" title="<?=$emailTitle;?>" /></p>
