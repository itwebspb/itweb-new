...
<?if($arResult['ITEMS']):?>
    ...
    <div class="top_wrapper items_wrapper simple <?=$templateName; ?>_template">
        ...
        <div class="catalog_block items row margin0 js_append ajax_load block flexbox<?= $bSlide ? ' owl-carousel owl-theme owl-bg-nav visible-nav short-nav hidden-dots swipeignore ' : ''; ?>"<?if($bSlide):?>data-plugin-options='{"nav": true, "autoplay" : false, "autoplayTimeout" : "3000", "smartSpeed":1000, <?= count($arResult['ITEMS']) > 4 ? '"loop": true,' : ''; ?> "responsiveClass": true, "responsive":{"0":{"items": 2},"600":{"items": 2},"768":{"items": 3},"1200":{"items": 4}}}'<?endif; ?> <?if ($bUseSchema):?>itemscope itemtype="http://schema.org/ItemList"<?endif; ?>>
    <?endif; ?>
        ...
        <?foreach($arResult['ITEMS'] as $arItem) {?>
            ...
            if (!$emptyProductProperties) {?>
                ...
                <div class="catalog_item_wrapp catalog_item item_wrap main_item_wrapper <?= $arItem['OFFERS'] ? 'has-sku' : ''; ?>" id="<?=$arItem['strMainID']; ?>">
                    <div class="inner_wrap" <?if ($bUseSchema):?>itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product"<?endif; ?>>
                        ...
                        <div class="item_info"  <?if ($bUseSchema):?>itemprop="offers" itemscope itemtype="http://schema.org/Offer"<?endif; ?>>
                            ...
                            <div class="cost prices clearfix<?=$bOutOfProduction ? ' hidden' : '';?>">
