...
<?if(count($arResult['ITEMS']) >= 1) {?>
    ...
    ?>
        <?foreach($arResult['ITEMS'] as $arItem) {?>
            ...
            ?>
            <div class="list_item_wrapp item_wrap item item-parent clearfix bordered box-shadow js-notice-block" <?if ($bUseSchema):?>itemprop="itemListElement" itemscope="" itemtype="http://schema.org/Product"<?endif; ?>>
                ...
                <?if ($bUseSchema):?>
                    ...
                    ?>
                <?endif; ?>
                <div class="list_item item_info catalog-adaptive flexbox flexbox--row <?= $arItem['OFFERS'] ? 'has-sku' : ''; ?>" id="<?=$arItemIDs['strMainID']; ?>" <?if ($bUseSchema):?>itemprop="offers" itemscope itemtype="http://schema.org/Offer"<?endif; ?>>
            ...
            $boolShowProductProps = (isset($arItem['DISPLAY_PROPERTIES']) && !empty($arItem['DISPLAY_PROPERTIES'])); ?>
                    ...
                    <div class="information_wrapp main_item_wrapper">
                        <div class="information <?= $arItem['OFFERS'] && $arItem['OFFERS_PROP'] ? 'has_offer_prop' : ''; ?>  inner_content js_offers__<?=$arItem['ID']; ?>_<?=$arParams['FILTER_HIT_PROP']; ?>">
                            ...
                            <div class="cost prices clearfix<?=$bOutOfProduction ? ' hidden' : '';?> 99999">
                                <?if($arItem['OFFERS']):?>
