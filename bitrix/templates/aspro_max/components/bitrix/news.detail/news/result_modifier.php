...
/* */
$authorPropCode = TSolution::getFrontParametrValue('AUTHOR_PROPERTY_CODE');
if (TSolution\Author::isNeedShowByFilledProperty($arResult['PROPERTIES'][$authorPropCode])) {
    $author = new TSolution\Author($arResult['PROPERTIES'][$authorPropCode]);
    $arResult['AUTHOR'] = $author->getInfo();
    $arResult['AUTHOR']['URL'] = $author->getFilterUrl($arParams['IBLOCK_URL']);
}
