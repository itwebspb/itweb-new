        ...
        <div class="maxwidth-theme wides logo-row ">
                    ...
                    <div class="top-block lines-block items-wrapper header__top-inner">
                        <?if ($bIncludeRegionsList):?>
                            <div class="header__top-item ">
                                <div class="top-description no-title">
                                    <?TSolution\Functions::showRegionList();?>
                                </div>
                            </div>
                        <?endif;?>
                        ...
                        <div class="right-icons header__top-item showed">
                            <div class="line-block line-block--40 line-block--40-1200">
                                ...
                                <?if (TSolution::GetFrontParametrValue('THEME_SELECTOR') === 'Y'):?>
                                    <div class="line-block__item no-shrinked">
                                        <div class="wrap_icon">
                                            <?TSolution::showThemeSelector();?>
                                        </div>
                                    </div>
                                <?endif;?>
                                ...
                                <div class="line-block__item no-shrinked">
                                    <div class="wrap_icon inner-table-block1 person">
                                        <?=TSolution::showCabinetLink(true, true, 'big');?>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="subbottom header__top-part">
                <div class="header__top-inner">
                    ...
                    <?if (TSolution::GetFrontParametrValue('ORDER_BASKET_VIEW') === 'NORMAL'):?>
                        <div class="right-icons header__top-item logo_and_menu-row">
                            <div class="line-block__item line-block line-block--40 line-block--40-1200">
                                <?=TSolution::ShowBasketWithCompareLink('', 'big', '', 'wrap_icon wrap_basket baskets');?>
                            </div>
                        </div>
                    <?endif;?>
                </div>
...
<div class="sidebar_menu">
    <div class="sidebar_menu_inner">
        <div class="burger"><?=TSolution::showIconSvg('burger dark', SITE_TEMPLATE_PATH.'/images/svg/burger.svg');?></div>
        ...
        <div class="menu-wrapper">
            <?$APPLICATION->IncludeComponent(
                ...
                [
                    ...
                    "AJAX_CATALOG_SUBMENU" => TSolution::GetFrontParametrValue("AJAX_CATALOG_SUBMENU")
                ],
                false,
                ['ACTIVE_COMPONENT' => 'Y']
            );?>
