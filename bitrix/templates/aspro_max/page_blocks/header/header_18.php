...
<div class="top-block top-block-v1 header-v18 header-wrapper">
	<div class="maxwidth-theme logo_and_menu-row logo_top_white">
		<div class="wrapp_block wrapp_block--display-block logo-row logo_top_white">
			<div class="items-wrapper header__top-inner">
				<?if($bIncludeRegionsList):?>
					<div class="header__top-item visible-by-block-presence">
                ...
                <div class="header__top-item soc dotted-flex-1 minwidth0">
				...
				<div class="right-icons showed wb  logo_and_menu-row to-mr header__top-item">
					<div class="line-block line-block--40 line-block--40-1200">
						...
						<?endif;?>
                        <?if (CMax::GetFrontParametrValue("THEME_SELECTOR") === "Y"):?>
                            <div class="line-block__item no-shrinked">
                                <div class="wrap_icon">
                                    <?CMax::showThemeSelector();?>
                                </div>
                            </div>
                        <?endif;?>
						<div class="line-block__item">
